...
export function InfoCard({
  ...
  return (
    <div
      className="bg-paper-200 rounded-xl shadow-md flex flex-col items-start justify-center relative overflow-hidden border border-gray-100 transition-transform hover:scale-[1.02] p-4"
