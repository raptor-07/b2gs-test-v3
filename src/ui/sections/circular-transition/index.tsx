...
import { LottieStack } from "./LottieStack";
      ...
      <Container>
        ...
        >
          <div className="grid grid-rows-3 grid-cols-2 gap-y-8 gap-x-6">
            {/* Titles: 1r1c-1r2c */}
            <div className="row-start-1 row-end-2 col-start-1 col-end-3 flex flex-col items-center gap-2">
              <h2 className="text-lg md:text-2xl lg:text-2xl xl:text-3xl font-medium text-mint-950 leading-tight text-center">
                CircularTransition
              </h2>
              <p className="text-base md:text-lg text-mint-950 max-w-2xl text-center">
                Subtitle for the CircularTransition section goes here.
              </p>
            </div>
            ...
            <div className="row-start-3 row-end-4 col-start-1 col-end-3 flex flex-col md:flex-row justify-center items-center gap-6 md:gap-6 w-full">
              <InfoCard
                title="Materials Saved"
                number={1200}
                description="Tons of material diverted from landfill"
                particleConfigs={[{ /* random config 1 */ }, { /* random config 2 */ }]}
              />
              <InfoCard
                title="CO₂ Reduced"
                number={350}
                description="Metric tons of CO₂ emissions avoided"
                particleConfigs={[{ /* random config 3 */ }, { /* random config 4 */ }]}
              />
              <InfoCard
                title="Products Recycled"
                number={5000}
                description="Units successfully recycled"
                particleConfigs={[{ /* random config 5 */ }, { /* random config 6 */ }]}
              />
            </div>
          </div>
        </InViewPopIn>
