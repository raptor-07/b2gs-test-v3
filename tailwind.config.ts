...
const config: Config = {
  ...
  safelist: [
    {
      pattern: /^bg-(primary|secondary|complementary|accent|illustrations)-(50|100|200|300|400|500|600|700|800|900|950)/,
    },
    {
      pattern: /^text-(primary|secondary|complementary|accent|illustrations)-(50|100|200|300|400|500|600|700|800|900|950)/,
    },
    {
      pattern: /^border-(primary|secondary|complementary|accent|illustrations)-(50|100|200|300|400|500|600|700|800|900|950)/,
    }
  ],
  theme: {
    extend: {
